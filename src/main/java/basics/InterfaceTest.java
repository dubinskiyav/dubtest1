...
public class InterfaceTest {
    ...
    public void test1() {
        ...
        /*
        Получается, что интерфейс basics.Printable - это абстрактный класс у которого есть наследники
        basics.Dishes и basics.Food
        и мы можем создавать экземпляры этого абстрактного класса
        причем хоть basics.Dishes хоть basics.Food и у них гарантированно вызывать метод print
         */
        ...
        // Причем, не у всех экземпляров p есть метод getName, например, у basics.Food его нет
        p.printDef();
        p = new Food("Чай");
        p.printDef();
